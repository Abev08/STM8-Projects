...
extern void delay_us(unsigned int value); // External delay ns function
...
void STP16CP05_Write8bits(uint8_t in)
{
	...
	{
		// Output high / low on SDI line depending on passed parameter
		if ((0x80 & (in << i)) > 0) GPIO_WriteHigh(STP16CP05_PORT, STP16CP05_SDI);
		//if (((in >> i) & 0x01) > 0) GPIO_WriteHigh(STP16CP05_PORT, STP16CP05_SDI);
		else GPIO_WriteLow(STP16CP05_PORT, STP16CP05_SDI);
